...
import com.finalproj.safely.patient.Location
...
class HospitalLocationActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    companion object {
        ...
        private const val TAG = "HospitalLocationActivity" // for debugging
    }
            ...
            fusedLocClient.lastLocation.addOnCompleteListener {
                ...
                if (location != null) {
                    ...
                    patient_confirm_location.setOnClickListener {
                        ...
                        val intent =
                            Intent(this@HospitalLocationActivity, HospitalHomeActivity::class.java)
