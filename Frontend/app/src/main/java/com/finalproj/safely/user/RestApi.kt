...
interface RestApi {
    ...
    fun submitRecords(
        ...
        @Body medicalRecords: MedicalRecords,
        @Header("token") token: String,
    ...
    @POST("/api/hospital")
    fun addHospitalInfo(
        @Body hospitalInfo: HospitalInfo,
        @Header("token") token: String,
    ): Call<SuccessMessageResponse>
    ...
    fun addDrAvailability(
        @Body availability: DrAvailabilityInfo,
        @Header("token") token: String,
    ): Call<SuccessMessageResponse>
    ...
    fun getAvailabilityByDrId(
        ...
        @Header("token") token: String,
    ): Call<List<DrAvailabilityResponse>>

    @Headers("Content-Type: application/json")
    @GET("/api/doctor/available/times")
    fun getTimesByAvailabilityId(
        @Query("id") availabilityId: String?,
        @Header("token") token: String,
    ): Call<TimesResponse>
